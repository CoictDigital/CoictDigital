            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-sm-12">
                    <form action="login.php" class="card p-5 rounded shadow login" method="POST">
                        ...
                        <div class="mb-3">
                            <input type="text" placeholder="Enter old password" name="oldpassword" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <input type="text" placeholder="Enter new password" name="newpassword" class="form-control" required>
                        </div>
                        <div class="mb-3">
