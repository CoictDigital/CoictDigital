        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
           ...
           <input type="hidden" name="course_code" class="form-control" id="course_code" value="<?php echo $courze['course_code']; ?>">
            ...
            <button type="submit" class="btn-get-started mb-3" name="deletecourse" value="deletecourse">Delete</button>
            </form>
            <a href="courses.php" class="btn-watch-video pt-2 align-items-center"><i class="bi bi-x-square"></i><span>Cancel</span></a>
            </center>
          </div>
