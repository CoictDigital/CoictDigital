  ...
  <main id="main">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="400">
            ...
            <div>
              ...
              <?php 
          $query ="SELECT Distinct COUNT(instructor) AS number_of_instructors FROM courses WHERE study_year='1'";
          $result = $conn->query($query);
          $count = mysqli_fetch_assoc($result)["number_of_instructors"];
          if($result->num_rows> 0){
    ?>
              <p class="description"><?php echo $count; } ?> total instructors</p>
            </div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="500">
            ...
            <div>
              ...
              <?php 
          $query ="SELECT Distinct COUNT(instructor) AS number_of_instructors FROM courses WHERE study_year='2'";
          $result = $conn->query($query);
          $count = mysqli_fetch_assoc($result)["number_of_instructors"];
          if($result->num_rows> 0){
    ?>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="600">
            ...
            <div>
              ...
              <?php 
          $query ="SELECT Distinct COUNT(instructor) AS number_of_instructors FROM courses WHERE study_year='3'";
          $result = $conn->query($query);
          $count = mysqli_fetch_assoc($result)["number_of_instructors"];
          if($result->num_rows> 0){
    ?>
    ...
    <section id="services-cards" class="services-cards">
      <div class="container">
        ...
        <div class="row gy-4">
        <div class="p-4">
        <h4 class="text-center">List of all instructors</h4>
...
<div class="p-4">
  ...
  <tbody>
                 <?php 
                  ...
                  $query ="SELECT * FROM courses WHERE instructor is not null ";
                  $result = $conn->query($query);
                  if($result->num_rows> 0){
